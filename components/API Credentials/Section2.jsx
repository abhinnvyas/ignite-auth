    ...
    <div className="flex w-full items-center space-x-4 border-2 p-2 rounded-lg">
      ...
      <div className="flex-1 w-full">
        ...
        <div className="flex space-x-4 items-center  ">
          <input
            className="bg-my_extra_light w-fit h-12 p-2 text-lg text-my_light rounded-lg opacity-80 border-2 border-gray-400 px-4 flex-1 max-w-lg cursor-not-allowed unselectable"
            type="text"
            placeholder
            value={ApiKey}
            disabled
